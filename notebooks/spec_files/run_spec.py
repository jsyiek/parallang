...
try:
    ...
    subprocess.run([sys.executable, "-m", "pip", "install", "install-jdk"])
...
local_java_install = os.path.abspath(os.path.join(JAVA_DIR, os.listdir(JAVA_DIR)[0]))
JAVA_BIN_FILE = os.path.join(local_java_install, "bin", "java")
